// ===========================================================
// Global error trap — if any module fails to load or throws,
// show it on-screen instead of hanging silently on load bar.
// ===========================================================
...
function showFatalError(msg) {
  ...
  if (loadTip) {
    loadTip.textContent = '⚠️ خطأ: ' + msg;
    loadTip.style.color = '#ff8080';
    loadTip.style.direction = 'ltr';
    loadTip.style.fontSize = '11px';
    loadTip.style.maxWidth = '80vw';
    loadTip.style.wordBreak = 'break-word';
  }
  if (loadBarWrap) loadBarWrap.style.display = 'none';
  const ls = document.getElementById('loadingScreen');
  if (ls) { ls.style.opacity = '1'; ls.style.display = 'flex'; }
}
